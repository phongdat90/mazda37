        ...
        <div class="pathpage group">
            <div class="container row group">
                <ol class="breadcrumb">
                    ...
                    <li class="active" itemprop="child" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" title="<?php echo $info->title;?>" href="<?php echo base_url('dich-vu').'/'.$info->slug.'.html'?>"><span itemprop="title"><?php echo $info->title;?></span></a></li>
                </ol>
            </div>
        </div>
                ...
                <div class="col col-right">
                    <div class="box group">
                        <div class="box-header">
                            <h4 class="box-title" lang="detailnews_morenews">Dịch vụ khác</h4>
                        </div>
