...
<head>
    ...
    <title>Bài viết tin tức về giá xe, thông số kỹ thuật, đăng ký lái thử trên giaxemazda37.com</title>
                ...
                <?php foreach($list_all as $row):?>
                    <div class="news-item group">
                        <div class="col col_4 news-item-img">
                            <a href="<?php echo base_url('tin-tuc').'/'.$row->slug.'.html'?>" title="<?php echo $row->title;?>"><img class="img-responsive" alt="<?php echo $row->title;?>" src="<?php echo $row->image_link; ?>" /></a>
                        </div>
                        <div class="col col_8 news-item-caption">
                            <h3 class="news-item-title">
                                <a href="<?php echo base_url('tin-tuc').'/'.$row->slug.'.html'?>" title="<?php echo $row->title;?>"><?php echo $row->title;?></a>
                            </h3>
