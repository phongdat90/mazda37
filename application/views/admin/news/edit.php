...
<div class="tab_content pd0" id="tab1" style="display: block;">
	...
	<div class="formRow">
            ...
            <div class="formRight">
              <span class="oneTwo"><input type="text" value="<?php echo $news->slug; ?>" _autocheck="true" id="param_name" name="slug"></span>
...
<div class="formRow">
		...
		<div class="formRight">
			<span class="oneTwo"><input type="text" _autocheck="true" id="param_title" name="site_title" value="<?php echo !empty($news->site_title) ? $news->site_title : ''?>" /></span>
	...
	<div class="formRight">
		<div class="left">
    		...
    		<input type="text" name="image" id="image" value="<?php echo $news->image_link ?>" size="50">
    		
    		<?php if($news->image_link != ''): ?>
    		<img src="<?php echo $news->image_link ?>" width="100px" alt=""  style="display: block">
	    	<?php endif ?>
		</div>
	...
	<div class="formRow">
		...
		<div class="formRight">
			<select name="status" id="status">
				...
				<option value="1" <?php echo !empty($news->status == 1) ? 'selected' : ''?>>Có</option>
			</select>
		<div class="clear error" name="name_error"></div>
		</div>
		<div class="clear"></div>
	...
	<div class="formRight">
		<textarea _autocheck="true" id="intro" name="intro"><?php echo $news->intro?></textarea>
		<span class="autocheck" name="meta_desc_autocheck"></span>
		<div class="clear error" name="meta_desc_error"></div>
	</div>
	<div class="clear"></div>
...
<script>CKEDITOR.replace( 'intro' );</script>	
	<div class="formRow">
    	...
    	<div class="formRight">
    		<textarea class="editor" id="content" name="content"><?php echo $news->content?></textarea>
